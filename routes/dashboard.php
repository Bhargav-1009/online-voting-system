...
<html>
    ...
    <body>
            ...
            <center>
            <div id="headerSection" style='background-image: url("C:/Users/bharg/OneDrive/Desktop/logo.png");'>
            <!-- <a href="../index1.php"><button id="back-button"> Back</button></a> -->
            ...
            <div id="mainSection">
                <div id="profileSection" style="border: 3px dashed black;">
                ...
                <div id="groupSection">
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                <div style="border-bottom: 4px solid #bdc3c7; margin-bottom: 10px ;">
